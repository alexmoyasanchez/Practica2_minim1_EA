  ...
  ngOnInit(): void {
    ...
    this.grupoService.getGrupo(this.id).subscribe(data =>{
      ...
      this.grupoinvestigacionForm = this.formBuilder.group({
        ...
        nombre: [this.user.nombre, [Validators.required, Validators.nullValidator]],
        direccion: [this.user.direccion, [Validators.required, Validators.nullValidator]],
        dni: [this.user.id, [Validators.required, Validators.nullValidator]],
